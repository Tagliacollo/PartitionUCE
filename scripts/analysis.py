...
datasets = ['/home/rlanfear/github/PartitionUCE/raw_data/Crawford_2012.nex']
...
for dataset_path in datasets:
	...
	print(asctime())
	process_dataset_full_multi(dataset_path, minimum_window_size = 50, outfilename = '%s.csv' % name)
	print(asctime())
