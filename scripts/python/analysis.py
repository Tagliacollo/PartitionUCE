...
datasets = ['/Users/roblanfear/Documents/github/PartitionUCE/raw_data/test/mini_matrix.nex']
...
for dataset_path in datasets:
	...
	print(asctime())
	process_dataset_metrics(dataset_path, ['entropy', 'gc', 'multi'], minimum_window_size = 10, outfilename = '%s.csv' % (name))
	print(asctime())
	#process_dataset_site_position(dataset_path, minimum_window_size = 5, outfilename = name)
	print(asctime())
	#process_dataset_full_multi(dataset_path, minimum_window_size = 5, outfilename = '%s.csv' % name)
	print(asctime())
